...
use super::model::{
    BetfairDomain, BetfairSession, KeepAliveResponse, MarketBookRequest, MarketCatalogueRequest,
    MarketFilter, NavigationNode, PriceProjection,
};
...
impl BetfairClient {
    pub fn new(app_key: &str, cert_path: &str, key_path: &str, insecure: bool) -> Result<Self> {
        ...
        headers.insert("X-Application", app_key.clone());
